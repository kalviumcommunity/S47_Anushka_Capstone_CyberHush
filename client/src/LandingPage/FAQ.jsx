...
function FAQ() {
  return (
    <div>
      ...
      <p>
        CyberHush is a platform dedicated to cybercrime awareness and reporting.
        Its primary purpose is to educate users about various cyber threats and
        provide a safe space for reporting incidents without fear of
        repercussions.
      </p>
      ...
      <p>
        Reporting a cybercrime incident on CyberHush is easy. Simply navigate to
        the reporting section of the platform and follow the provided
        instructions to submit details about the incident, including any
        relevant evidence or documentation.
      </p>
      <h4>4. Is CyberHush free to use?</h4>
      <p>
        Yes, CyberHush is completely free to use for all users. We believe that
        access to information and support related to cybercrime should be
