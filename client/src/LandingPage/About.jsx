        ...
        {showFullContent ? (
          <>
            <h2 className={styles.fullContent}>
              ...
              types of cybercrimes, from online harassment to phishing scams,
              and learn how to protect yourself and your loved ones. Our
              user-friendly interface makes it easy to report cybercrime
              incidents you've experienced or witnessed, empowering you to make
              a difference in combating online threats. Join us in the fight
              against cyber threats. Let's make the internet a safer place for
              all.
            </h2>
          </>
        ) : (
